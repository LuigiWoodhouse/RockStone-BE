...
public class VoiceTextControllerTest {
    ...
    @Test
    @Description("Return HTTP status 200 when the convertAudio enpdoint is called")
    public void convertAudio_SUCCESS() throws IOException {

        Object transcriptedAudio = new Object();
        ...
        expecteResponse = new ResponseEntity<>( HttpStatus.OK);


        Mockito.when(parseAudioService.convertAudioToByteString(Mockito.any())).thenReturn((ByteString) transcriptedAudio);

        Assert.assertEquals(expecteResponse.getStatusCode(), response.getStatusCode());

    }

    @Test
    @Description("Return HTTP status 400 when the convertAudio enpdoint is called")
    public void convertAudio_BAD_REQUEST() throws IOException {
        ...
        expecteResponse = new ResponseEntity<>( HttpStatus.BAD_REQUEST);
    ...
    @Test
    @Description("Return HTTP status 500 when the convertAudio enpdoint is called")
    public void convertAudio_INTERNAL_SERVER_ERRROR() throws IOException {
        ...
        expecteResponse = new ResponseEntity<>( HttpStatus.INTERNAL_SERVER_ERROR);
